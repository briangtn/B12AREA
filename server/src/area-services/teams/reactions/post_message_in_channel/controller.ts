...
import {TeamsHelper, TeamsPostMessageInChannelOptions, TeamsTokens} from "../../helper";
...
export default class ReactionController {
    static async trigger(params: WorkableObject): Promise<void> {
        const reactionOptions: TeamsPostMessageInChannelOptions = params.reactionOptions as TeamsPostMessageInChannelOptions;
        ...
        try {
            await axios.post(`https://graph.microsoft.com/beta/teams/${teamsTeamId}/channels/${teamsChannelId}/messages`, {
                "body": {
                    "contentType": "html",
            ...
            console.debug(`Failed to post message to ${teamsTeamId}/${teamsChannelId}. Message: ${teamsMessage}`, e);
            return;
        }
    }
